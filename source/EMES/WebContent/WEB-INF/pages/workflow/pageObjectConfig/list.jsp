...
<script type="text/javascript">
	...
	var parameter = {
		...
		// 模块URL
		moduleUrl: '${ctx}/workflow/pageObjectConfig'
	};
	...
	function deleteBtn(id){
		...
		var confirm = function (v, h, f) {
			if (v == 'ok') {
				form.attr("action", '${ctx}/workflow/pageObjectConfig/delete.do?id='+id).submit();
				return true;
			}else if (v == 'cancel') {
				return true;
			}
...
<div id="content">
	...
	<div class="search">
		<form:form id="searchForm" modelAttribute="pageObjectConfigSearchCondition" action="${ctx}/workflow/pageObjectConfig/list.do" method="post">
