...
<html>
            ...
            <sf:form id="voModelFrm" action="jsonSave.do" commandName="voModel">
                ...
                <table width="99%" align="center" class="editTable">
                    ...
                    <tr>
                        ...
                        <td class="fieldcell">
                            <sf:input path="communicateAddr" size="40" maxlength="100" />
                    ...
                    <tr>
                        ...
                        <td class="fieldcell">
                            <select id="regionCode" name="regionCode" style="width:120px">
                                <c:forEach items="${areas}" var="area">
                                    <option value="${area.code}" <c:if test="${voModel.regionCode == area.code}">selected</c:if>>
                                        ${area.name}
                                    </option>
                                </c:forEach>
                            </select>
                    ...
                    <tr>
                        ...
                        <td class="fieldcell">
                            <hgf:DataDicSelect type="iType" id="iType" path="iType" cssClass="select" required="false" style="width:120px"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="20%" class="labelcell">
    ...
    Ext.onReady(function() {
        ...
        var editPage = new Ext.mk.EditPage();
        var closeBtn = Ext.get('closeBtn');
        closeBtn.on('click', editPage.closeWindow);
        //初始光标设置
        Ext.get('psname').focus();
    });
</script>
</html>
