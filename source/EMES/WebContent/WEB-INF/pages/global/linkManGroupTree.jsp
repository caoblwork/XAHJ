...
<%@ include file="/components/zTree/zTree.jsp"%>
	<SCRIPT type="text/javascript">
		var setting = {
			...
			async: {
				enable: true,
				url:'<c:url value="/global/linkManGroupData.do?group=${param.group}"/>',
				autoParam:["id"]
			},
			callback: {
		...
		var zTreeNodeStr = "${linkManGroups}";
		...
		function multSelect(event, treeId, treeNode, clickFlag) {
			//获取多选择值
			var zTree = $.fn.zTree.getZTreeObj("linkManGroupTree"),
		...
		$(document).ready(function(){
			$.fn.zTree.init($("#linkManGroupTree"), setting, zNodes);
		});
	</SCRIPT>
</HEAD>

<BODY>
	<ul id="linkManGroupTree" class="ztree"></ul>
</BODY>
</HTML>