...
<script type="text/javascript">
	...
	<form:form id="form" modelAttribute="voModel" method="post" action="save.do" class="well form-horizontal">
		...
		<div class="control-group">
            ...
            <div class="controls">
				<form:input path="projectCode"  maxlength="48" check-type="char" char-message="请输入英文编码名!"/>
		...
		<div class="control-group">
		 ...
		 <div class="control-group">
	          ...
	          <div class="control-group">
					...
					<div class="controls">
						<div class="input-append date" id="tc">
							<form:input path="operatorManger"  readonly='true' type="text" id="operatorManger"
							...
							<span class="add-on"><i class="icon-th"
								onClick="$.jBox.open('iframe:<c:url value="/global/loadLinkManGroup.do?group=true&selectParent=false&index=0"/>', '请单击选择负责人', 400, 400, {id:'jbox1',iframeScrolling: 'no', buttons: {'清空': 0, '关闭': true},submit:cleanOrganUserData } )"></i></span>							 	 						
						</div>
						<form:errors path="operatorMangerId" />
			 ...
			 <div class="control-group">
					...
					<div class="controls">
						<div class="input-append date" id="tc">
							<form:input path="customerManger"  readonly='true' type="text" id="customerManger"
							...
							<span class="add-on"><i class="icon-th"
								onclick="$.jBox.open('iframe:<c:url value="/global/loadLinkManGroup.do?group=true&selectParent=false&index=1"/>', '请单击选择负责人', 400, 400, {id:'jbox2',iframeScrolling: 'no', buttons: {'清空': 0, '关闭': true},submit:cleanOrganUserData } )"></i></span>					         	 						    
						</div>
					</div>
						<form:errors path="customerMangerId" />						
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append date" id="dp2" data-date-format="yyyy-mm-dd">
							<form:input path="projectStartTime" id="projectStartTime" type="text"
								readonly='true' />							
							<span class="add-on"><i class="icon-calendar"> </i></span>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-append date" id="dp3"
							...
							<form:input path="projectCloseTime" id="projectCloseTime" type="text"
								readonly='true'/>									
							<span class="add-on"><i class="icon-calendar" > </i></span>
