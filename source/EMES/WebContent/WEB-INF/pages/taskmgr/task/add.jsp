	...
	<form:form id="form" modelAttribute="voModel" method="post"
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:hidden path="projectId" value="${param.id}" />
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label" for="status">任务进度:</label>
			<div class="controls">
				<form:input path="status" check-type="number"
					number-message="任务进度须为0~100之间的整数!" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append date" id="tc">
					<form:input path="organizationName" check-type="required"
						required-message="下发机构不能为空,请选择!" readonly='true' type="text"
