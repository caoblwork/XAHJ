...
<body>
	...
	<form:form id="form" modelAttribute="voModel" method="post" action="save.do" class="well form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="organizationName" type="text" readonly='readonly' class="span8" id="organizationName" placeholder="点击图标选择部门" check-type="required" required-message="请选择部门!">
				<input type="hidden" id="organizationId" name="organizationId"> <span class="add-on"><i class="icon-th"
					onclick="$.jBox.open('iframe:${ctx}/global/loadOrganUsers.do?user=false', '请单击选择部门', 400, 400, {iframeScrolling: 'no', buttons: {'清空': 0, '关闭': true},submit:cleanOrganUserData } )"></i></span>
			</div>
		...
		<div class="form-actions">
			<input type="submit" id="saveBtn" name="saveBtn" value="保存" class="btn btn-primary"> <input id="cancel" class="btn" type="button" value="返回"
