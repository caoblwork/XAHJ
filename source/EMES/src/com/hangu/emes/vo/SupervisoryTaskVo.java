 ...
 * @version 1.0
 */
public class SupervisoryTaskVo extends BaseVo {
    /** 序列化ID */
    private static final long serialVersionUID = 5114624216071564414L;
	/** 名称 */
	...
	/**
     * @param pollutantSourceId the pollutantSourceId to set
     */
	...
	/**
     * @param monitorItem the monitorItem to set
     */
