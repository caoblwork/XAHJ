...
/**
 * SupervisoryTask查询条件对象
 * 
 * @author 修改成自己的名字
 * @version 1.0
 */
public class SupervisoryTaskSearchCondition extends SearchCondition {
	/** 序列化ID */
	private static final long serialVersionUID = 8516291256728142758L;
	/** 名称 */
