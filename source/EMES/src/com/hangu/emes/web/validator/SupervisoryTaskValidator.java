 ...
 * @version 1.0
 */
public class SupervisoryTaskValidator extends BaseValidator<SupervisoryTaskVo> {
	/** 序列化ID */
	private static final long serialVersionUID = -1179058850905605817L;
	...
	public void validate(Object target, Errors errors) {
		SupervisoryTaskVo vo = (SupervisoryTaskVo) target;
	}
}
