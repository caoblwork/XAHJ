...
/**
 * PageObjectConfig查询条件对象
 * 
 * @author 李显锋
 * @version 1.0
 */
public class PageObjectConfigSearchCondition extends SearchCondition {
	/** 序列化ID */
	private static final long serialVersionUID = -8561853370136063395L;
	/** 表单以及表单绑定对象的配置关系 */
